...
if parsed["parametros"]["analisis"] == "C":  
	...
	###### Generar Roc DCA #####
	TPR_Rate_DCA,FPR_Rate_DCA,Venn_TP_DCA = Modulo_Combinado.roc(DCA_Z,dist_dic,"DCA",graficos_ruta,temporal)
	...
	###### Generar Roc Mistic #####
	TPR_Rate_MI,FPR_Rate_MI,Venn_TP_MI = Modulo_Combinado.roc(Mis_Z,dist_dic,"Mistic",graficos_ruta,temporal)
	...
	TPR_Rate_C,FPR_Rate_C,venn_TP_Comb = Modulo_Combinado.roc(Comb_Z,Comb_Dist,parsed["parametros"]["metodo_comb"],graficos_ruta,temporal)
	...
	######### Diagrama Venn #########
	venn_all_metodos = []
	venn_TP_Mult= Modulo_Combinado.Class_Venn(dist_dic,Mult_Z,temporal,parsed["parametros"]["venn_1"])
	venn_TP_Para= Modulo_Combinado.Class_Venn(dist_dic,Para_Z,temporal,parsed["parametros"]["venn_2"])
	
	Modulo_Combinado.Venn_Inter(dist_dic,venn_TP_Comb,Venn_TP_DCA,Venn_TP_MI,graficos_ruta,"comb") #Solo Mejor Metodo
	
	venn_all_metodos=Modulo_Combinado.Venn_Unificar(venn_TP_Mult,venn_TP_Para,venn_TP_Comb)
	
	Modulo_Combinado.Venn_Inter(dist_dic,venn_all_metodos,Venn_TP_DCA,Venn_TP_MI,graficos_ruta,"all") #Solo Mejor Metodo
	
	Modulo_Combinado.Venn_Intra(dist_dic,venn_TP_Comb,venn_TP_Mult,venn_TP_Para,graficos_ruta)
